...
import { Bell, BookOpen, MessageSquare, Search, Command } from "lucide-react";
import { ConnectButton } from "@rainbow-me/rainbowkit";

export const TopNav = () => {
  return (
    <div className="h-20 border-b border-white/5 bg-[#050816]/40 backdrop-blur-xl flex items-center justify-between py-3 px-8 sticky top-0 z-40">
