...
const menuItems = [
  { icon: Home, label: "Home", href: "/dashboard/projects" },
  { icon: Code2, label: "Code", href: "#", isActive: true },
  { icon: FileCode2, label: "Contracts", href: "#" },
  { icon: Webhook, label: "API", href: "#" },
  ...
  return (
    <div className="w-64 h-screen bg-[#050816]/80 backdrop-blur-2xl border-r border-white/5 flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-4 space-y-4">
        <Link
          href="/pricing"
          className="w-full p-4 rounded-2xl bg-gradient-to-br from-purple-600/20 to-blue-500/10 border border-purple-500/20 flex flex-col gap-2 group hover:border-purple-500/40 transition-all"
        >
