    ...
    <div className="p-12 max-w-5xl mx-auto">
      <div className="flex flex-col items-center text-center mb-16">
        ...
        >
          ...
          <span className="text-[12px] text-purple-300 font-medium">AI Web3 Builder</span>
        </motion.div>
        ...
        >
          ...
          With <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">AI on 0G.</span>
        </motion.h1>
        ...
        >
          0GPilot is your autonomous AI engineer for building, deploying, and managing full-stack Web3 applications.
        </motion.p>
      </div>
      ...
      <div>
        <h3 className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-6">Try these examples</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          {examples.map((example, i) => (
            ...
            >
              ...
              <h4 className="text-[13px] font-bold text-white mb-1 group-hover:text-purple-400 transition-colors">{example.title}</h4>
